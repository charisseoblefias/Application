package com.example.application.tasksbottomSheetFragment;
...
public class CreateTaskBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    public void setTaskId(int taskId, boolean isEdit, setRefreshListener setRefreshListener, ToDoActivity activity) {
        this.taskId = taskId;
        this.isEdit = isEdit;
    ...
    private void createTask() {
        class saveTaskInBackend extends AsyncTask<Void, Void, Void> {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                if (!isEdit)
                    TasksDatabaseClient.getInstance(getActivity()).getAppDatabase()
                            .dataBaseAction()
    ...
    private void showTaskFromId() {
        class showTaskFromId extends AsyncTask<Void, Void, Void> {
            ...
            @Override
            protected Void doInBackground(Void... voids) {
                task = TasksDatabaseClient.getInstance(getActivity()).getAppDatabase()
