package com.example.application.tasksadapter;
...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public TaskAdapter(ToDoActivity context, List<Task> taskList, CreateTaskBottomSheetFragment.setRefreshListener setRefreshListener) {
    ...
    public void showPopUpMenu(View view, int position) {
        ...
        popupMenu.getMenuInflater().inflate(R.menu.tasksmenu, popupMenu.getMenu());
    ...
    public void showCompleteDialog(int taskId, int position) {
        ...
        dialog.setContentView(R.layout.dialog_tasks_completed_theme);
    ...
    private void deleteTaskFromId(int taskId, int position) {
        class GetSavedTasks extends AsyncTask<Void, Void, List<Task>> {
            ...
            protected List<Task> doInBackground(Void... voids) {
                TasksDatabaseClient.getInstance(context)
                        .getAppDatabase()
                        .dataBaseAction()
